					...
					<div class="mb-6">
						...
						<div class="grid grid-cols-2 gap-4">
							...
							<div>
								...
								ark:text-white dark:border-none @error('last_name') border-red-500 @enderror" id="last_name" type="text">
								</input>
								@error('last_name')
									<div class="text-red-500 text-sm">
										{{$message}} 
						...
						<div class="mt-4">
							...
							<input wire:model='address' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 
							dark:text-white dark:border-none @error('address') border-red-500 @enderror" id="address" type="text">
							</input>
							@error('address')
								<div class="text-red-500 text-sm">
									{{$message}} 
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							...
							<div>
								...
								<input wire:model='zip' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 
								dark:text-white dark:border-none @error('zip') border-red-500 @enderror" id="zip" type="text">
								</input>
								@error('zip')
									<div class="text-red-500 text-sm">
										{{$message}} 
							...
							<li class="py-3 sm:py-4" wire:key="{{$it['product_id']}}">
								<div class="flex items-center">
									<div class="flex-shrink-0">
										<img alt="{{$it['name']}}" class="w-12 h-12 rounded-full" src="{{url('storage',$it['image'])}}">
										</img>
									</div>
									...
									<div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
										{{Number::currency($it['total_amount'],'MAD')}}
									</div>
								</div>
							</li>
						@endforeach
