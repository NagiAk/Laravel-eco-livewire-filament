                ...
                <div class="p-4 sm:p-7">
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent='save'>
                            @if (session('success'))
                                <div class="mt-2 bg-green-100 border border-green-200 text-sm text-green-800 rounded-lg p-4 mb-3 dark:bg-red-800/10 dark:border-green-900 dark:text-green-500"
