                ...
                <div class="p-4 sm:p-7">
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent='save'>
                            @if (session('error'))
                                <div class="mt-2 bg-red-100 border border-red-200 text-sm text-red-800 rounded-lg p-4 mb-3 
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="password" id="password" wire:model="password"
                                            class="py-3 px-4 block w-full border border-gray-200 rounded-lg 
                                    ...
                                    @error('password')
                                        <p class="hidden text-red-600 mt-2" id="password-error">
                                            {{$message}}
                                        </p>
                                    @enderror
                                </div>
