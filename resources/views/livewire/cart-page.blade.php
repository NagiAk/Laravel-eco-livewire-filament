                        ...
                        <tbody>
                            @forelse ($cart_items as $item)
                                <tr wire:key='{{$item['product_id']}}'>
                                    ...
                                    <td class="py-4">{{ Number::currency($item['unit_amount'],'MAD') }}</td>
                                    <td class="py-4">
                                        <div class="flex items-center">
                                            <button wire:click='decraeseQty({{$item['product_id']}})'
                                    ...
                                    <td class="py-4">{{ Number::currency($item['total_amount'],'MAD') }}</td>
                                    <td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4 text-4xl font-semibold text-slate-500">No items added to cart</td>
                                    </tr>
                            @endforelse
                        </tbody>
                    </table>
