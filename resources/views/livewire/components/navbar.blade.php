                        ...
                        @auth
                            <div x-data="{ open: false }" class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:py-4">
                                ...
                                <div x-show="open" @mouseover="open = true" @mouseleave="open = false"
                                    class="hs-dropdown-menu absolute z-10 bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:dark:border dark:border-gray-700 dark:divide-gray-700 opacity-100 md:w-48">
